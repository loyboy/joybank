package com.loysupremo.joybank.controller.security;
...
//        if(verify){
    		...
    		if(role.equalsIgnoreCase("ROLE_REGULAR") || role.equalsIgnoreCase("ROLE_MANAGER") || role.equalsIgnoreCase("ROLE_ADMIN")){
    			...
    			ctx.close();
    			arg1.sendRedirect("/JoyBank-1.0-SNAPSHOT/employee/home");
    		}else{
    			...
    			arg1.setStatus(HttpServletResponse.SC_OK);
    			ctx.close();
    			arg1.sendRedirect("/JoyBank-1.0-SNAPSHOT/customer/home");
    		}
//        }else{
